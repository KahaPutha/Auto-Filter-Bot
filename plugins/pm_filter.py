...
async def give_filter(client, message):
    ...
    if settings["auto_filter"]:
        if message.chat.id == SUPPORT_GROUP:
            ...
            if files:
                btn = [[
                    InlineKeyboardButton("Here", url='https://t.me/Unlimited_Movie_Zone')
                ]]
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('ɪʟʟᴇɢᴀʟ ʀᴇQᴜᴇꜱᴛ ʟᴏɢꜱ', url=f'https://t.me/Unlimited_Movie_Zone')
        ],[
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url=f'https://t.me/Unlimited_Movie_Zone'),
            InlineKeyboardButton('Channel', url=f'https://t.me/Unlimited_Movie_Zone')
        ],[
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url=f'https://t.me/Unlimited_Movie_Zone'),
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇ', url=f'https://t.me/Unlimited_Movie_Zone')
        ],[
