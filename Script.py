class script(object):
    ...
    START_TXT = """<b>Welcome to umzfilter_bot 🚩 {}, <i>{}</i>
...
ɪ ᴀᴍ ᴘᴏᴡᴇʀғᴜʟ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴡɪᴛʜ ʟɪɴᴋ sʜᴏʀᴛᴇɴᴇʀ ʙᴏᴛ. ʏᴏᴜ ᴄᴀɴ ᴜꜱᴇ ᴀꜱ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴡɪᴛʜ ʟɪɴᴋ sʜᴏʀᴛᴇɴᴇʀ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ... ɪᴛ'ꜱ ᴇᴀꜱʏ ᴛᴏ ᴜꜱᴇ ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴀꜱ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ᴍᴏᴠɪᴇꜱ ᴡɪᴛʜ ʏᴏᴜʀ ʟɪɴᴋ ꜱʜᴏʀᴛᴇɴᴇʀ... ♻️</b>"""
 ...
 ✯ ᴍʏ ɴᴀᴍᴇ : umzfilter_bot ≛
 ✯ ᴅᴇᴠᴇʟᴏᴘᴇʀ : Witcher 🕷
 ✯ ʙᴏᴛ sᴇʀᴠᴇʀ : ᴘʀɪᴠᴀᴛᴇ
 ✯ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ2.7.1 [sᴛᴀʙʟᴇ]</b>"""

    YOUR_ABOUT_TXT = """<b>✯ Mʏ Nᴀᴍᴇ : 𓆩umzfilter_bot𓆪

✯ Cʀᴇᴀᴛᴏʀ : 𒆜 Witcher ࿐

✯ Uᴘᴅᴀᴛᴇs : Unlimited_Movie_Zone ⚡
...
📢 Bᴏᴛ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ.</b>"""
    ...
    MY_OWNER_TXT = """<b>★ Name: Witcher
★ Username: @GwitcherG
★ ID: <code>1087141176</code>
★ Country: Sri Lanka </b>"""
...
» sᴛᴇᴘ 2:- ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ <a href=https://exe.io/>exe.io</a> [ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴏᴛʜᴇʀ sʜᴏʀᴛɴᴇʀ ᴡᴇʙsɪᴛᴇ ]
...
©️ Powered by: <b>{message.chat.title}</b>"""
    ...
    FILE_CAPTION = """<b><a href='https://t.me/Unlimited_Movie_Zone'>{file_name}</a>

🔰 Join For Enjoy
@Unlimited_Movie_Zone
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>
...
- ꜱᴏᴜʀᴄᴇ - <a href=https://t.me/GwitcherG>☏ ᴄᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ</a>

🧑‍💻 ᴅᴇᴠʟᴏᴘᴇʀ -
<a href=https://t.me/GwitcherG>Witcher</a></b>🕷"""
